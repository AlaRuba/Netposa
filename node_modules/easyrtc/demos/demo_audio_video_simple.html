...
<html>
    ...
    <body onload="connect();">
        ...
        <canvas id="buttonCanvas" style=" 
                            ...
                            margin-right: auto;
                            width: 937px;
                            z-index: 2;" width="937" height="800"></canvas>

        <canvas id="callerVideoCanvas" style=" 
                            position:absolute;
                            padding-left: 0;
                            padding-right: 0;
                            margin-left: 15%;
                            margin-right: auto;
                            width: 937px;
                            z-index: 1;" width="937" height="800"></canvas>
                           


            <img id="dark" width="1000" height="800" src="images/bg_dark.png" style="position:absolute;z-index:-1;" />
            ...
            <div id="main">
                ...
                <div id="demoContainer">
                    ...
                    <div id="videos">
                            ...
                            <video autoplay="autoplay" id="callerVideo" muted="muted" volume="0"></video>
                        </div>
                ...
                <!-- End Main Content -->
                <img id="placeholder" src="images/Joel_V2-1.jpeg" />
            </div>
        </div>
        <!--show-->
