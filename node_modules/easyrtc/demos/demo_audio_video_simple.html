...
<html>
    ...
    <body onload="connect();">
        ...
        margin-right: auto;
        width: 937px;
        z-index: -10" width="937" height="800"></canvas>
        <img id="dark" width="937" height="800" src="images/bg_dark.png" />
        <div id="container">
            <div id="header">
                <a href="index.html"><img id="logo_easyrtc" src="images/easyrtc_logo.png" alt="EasyRTC" style="z-index:5;" /></a>
            </div>
