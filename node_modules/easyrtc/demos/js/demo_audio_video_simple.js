...
function draw(v,c,w,h) {  
   ...
   if (lastScreen != null) {
        for(var i = 0; i < lastScreen.length; i+=4) {
            var lastBrightness = 0.34 * lastScreen[i] + 0.5 * lastScreen[i + 1] + 0.16 * lastScreen[i + 2];
            var currentBrightness = 0.34 * currentScreen[i] + 0.5 * currentScreen[i + 1] + 0.16 * currentScreen[i + 2];
        }
        console.log(abs(lastBrightness-currentBrightness));
   }
