...
function draw(v,c,w,h) {  
   ...
   for (var w1 = 0; w1 < width/4; w1++) {
    for (var h1 = 0; h1 < height/4; h1++) {
     ...
     if (lastScreen != null) {
          var lastBrightness = 0.34 * lastScreen.data[i] + 0.5 * lastScreen.data[i + 1] + 0.16 * lastScreen.data[i + 2];
          var currentBrightness = 0.34 * currentScreen.data[i] + 0.5 * currentScreen.data[i + 1] + 0.16 * currentScreen.data[i + 2];
