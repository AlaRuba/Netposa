...
function draw(v,c,w,h) {  
   ...
   console.log(currentScreen[10] );
   if (lastScreen != null) {
        var lastBrightness = 0.34 * lastScreen[10] + 0.5 * lastScreen[10 + 1] + 0.16 * lastScreen[10 + 2];
        var currentBrightness = 0.34 * currentScreen[10] + 0.5 * currentScreen[10 + 1] + 0.16 * currentScreen[10 + 2];
